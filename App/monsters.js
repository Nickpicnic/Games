class Monster extends Creature {
            ...
            (
                (!game.map[this.y][this.x].match(/^[#_,./|0:]$/) ||
                    (
                        ...
                        (this.x == game.player.x) && this.pldY >= 0)) && // Мы не на лестнице и не на веревке
    ...
    tick() {
        ...
        if (this.x == game.player.x && (this.y == game.player.y || (this.y + 1 == game.player.y && game.map[this.y][this.x] != ':'))) {
